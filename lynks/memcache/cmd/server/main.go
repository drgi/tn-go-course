...
import (
	...
	"github.com/tn-go-course/lynks/memcache/internal/config"
...
func main() {
	...
	cache := redis.New(cfg.Redis.Host, cfg.Redis.Port, cfg.Redis.Password, cfg.Redis.ValueLifeTimeHour)
	api := api.New(cache, mux.NewRouter(), &logger)
